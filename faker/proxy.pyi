...
from typing import List, Type, Callable, Collection, Sequence, Any, Optional, Union, Iterator, Iterable, Literal, Dict, Set, Tuple
...
class Faker:
    ...
    def random_choices(self, elements: Union[Collection[str], Collection[T], OrderedDict[T, float]] = ..., length: Optional[int] = ...) -> Sequence[T]: ...
    ...
    def random_elements(self, elements: Union[Collection[str], Collection[T], OrderedDict[T, float]] = ..., length: Optional[int] = ..., unique: bool = ..., use_weighting: Optional[bool] = ...) -> Sequence[T]: ...
    ...
    def random_sample(self, elements: Union[Collection[str], Collection[T], OrderedDict[T, float]] = ..., length: Optional[int] = ...) -> Sequence[T]: ...
    ...
    def color_hsl(self, hue: Optional[HueType] = ..., luminosity: Optional[str] = ...) -> Tuple[int, int, int]: ...
    def color_hsv(self, hue: Optional[HueType] = ..., luminosity: Optional[str] = ...) -> Tuple[int, int, int]: ...
    def color_name(self) -> str: ...
    def color_rgb(self, hue: Optional[HueType] = ..., luminosity: Optional[str] = ...) -> Tuple[int, int, int]: ...
    def color_rgb_float(self, hue: Optional[HueType] = ..., luminosity: Optional[str] = ...) -> Tuple[float, float, float]: ...
    ...
    def future_date(self, end_date: Union[datetime.date, datetime.datetime, datetime.timedelta, str, int] = ..., tzinfo: Optional[datetime.tzinfo] = ...) -> datetime.date: ...
    ...
    def unix_time(self, end_datetime: Union[datetime.date, datetime.datetime, datetime.timedelta, str, int, None] = ..., start_datetime: Union[datetime.date, datetime.datetime, datetime.timedelta, str, int, None] = ...) -> int: ...
    def year(self) -> str: ...
    def emoji(self) -> str: ...
    def file_extension(self, category: Optional[str] = ...) -> str: ...
    def file_name(self, category: Optional[str] = ..., extension: Optional[str] = ...) -> str: ...
    def file_path(self, depth: int = ..., category: Optional[str] = ..., extension: Optional[str] = ..., absolute: Optional[bool] = ...) -> str: ...
    ...
    def words(self, nb: int = ..., part_of_speech: Optional[str] = ..., ext_word_list: Optional[Sequence[str]] = ..., unique: bool = ...) -> List[str]: ...
    ...
    def json(self, data_columns: Optional[List] = ..., num_rows: int = ..., indent: Optional[int] = ..., cls: Optional[Type[JSONEncoder]] = ...) -> str: ...
    def json_bytes(self, data_columns: Optional[List] = ..., num_rows: int = ..., indent: Optional[int] = ..., cls: Optional[Type[JSONEncoder]] = ...) -> bytes: ...
    ...
    def uuid4(self, cast_to: Union[Callable[[UUID], str], Callable[[UUID], bytes], None] = ...) -> Union[bytes, str, UUID]: ...
    ...
    def simple_profile(self, sex: Optional[Literal['M', 'F']] = ...) -> Dict[str, Union[str, datetime.date, Literal['M', 'F']]]: ...
    def enum(self, enum_cls: Type[TEnum]) -> TEnum: ...
    def pybool(self, truth_probability: int = ...) -> bool: ...
    def pydecimal(self, left_digits=..., right_digits=..., positive=..., min_value=..., max_value=...): ...
    ...
    def __init__(self, locale: Union[str, Sequence[str], Dict[str, Union[int, float]], None] = ..., providers: Optional[List[str]] = ..., generator: Optional[Generator] = ..., includes: Optional[List[str]] = ..., use_weighting: bool = ..., **config: Any) -> None: ...
