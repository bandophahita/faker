...
from typing import Tuple, Collection, Iterator, Type, Any, Sequence, Iterable, Dict, Callable, Literal, List, Set, Optional, Union
...
class Faker:
    ...
    def pydecimal(self, left_digits: Optional[int] = ..., right_digits: Optional[int] = ..., positive: bool = ..., min_value: Optional[float] = ..., max_value: Optional[float] = ...) -> Decimal: ...
